...
@push('js_section')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Populate the subcategory dropdown if editing a project
            var selectedCategoryId = categorySelect.value;
            var selectedSubCategoryId = '{{ $project->sub_category_id }}'; // Get the selected subcategory ID from the project
