          ...
          <div class="container">
            <div class="row">
              <div class="col-auto">
                ...
                >
                  <h2 class="section-title-light mb-2">{{ __('translate.Subscription Plan') }}</h2>
                        ...
                        <div class="plan-table bg-white">
                            ...
                            <div class="plan-footer">
                                ...
                                @if ($plan->plan_price == 0.00)
                                    ...
                                    <button class="plan-footer-btn" onclick="enrolledTrailPackage('{{ route('seller.subscription.payment.free-enroll', $plan->id) }}')" >
                                        {{ __('translate.Trail Now') }}
                                        <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="18"
                                        height="19"
                                ...
                                @else
                                    ...
                                    <button class="plan-footer-btn" onclick="enrolledPackage('{{ route('seller.subscription.payment.pay', $plan->id) }}')" >
...
function enrolledTrailPackage(redirectUrl) {

    Swal.fire({
        title: "{{__('translate.Are you realy want to enroll trail version ?')}}",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: "{{__('translate.Yes, Enroll')}}",
...
function enrolledPackage(redirectUrl) {

    Swal.fire({
        title: "{{__('translate.Are you realy want to enroll this plan ?')}}",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
