...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('translate.Manage Refund') }} >> {{ $title }}</p>
@endsection
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            <a href="{{ route('admin.user-show', $refund->buyer_id) }}">{{ $refund?->buyer?->name }}</a>
                                                        </h4>
                                                    </td>

                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <h4 class="crancy-table__product-title">
                                                            <a href="{{ route('admin.order', $refund->order->order_id) }}">#{{ $refund->order->order_id }}</a>
                                                        </h4>
                                                    </td>
                                                    ...
                                                    <td class="crancy-table__column-2 crancy-table__data-2">
                                                        <a href="{{ route('admin.refund.show', $refund->id) }}" class="crancy-btn"><i class="fas fa-eye"></i> {{ __('translate.Show') }}</a>
