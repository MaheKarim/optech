                                        ...
                                        <div class="translation_box">
                                            <ul>
                                                @foreach ($language_list as $language)
                                                    <li><a href="{{ route('admin.team.edit', ['team' => $teamMember->id, 'lang_code' => $language->lang_code] ) }}">
                                            ...
                                            <div class="row">
                                                            ...
                                                            <div class="crancy__item-form--group w-100 h-100">
                                                                ...
                                                                <div class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                    ...
                                                                    <label class="crancy-image-video-upload__label" for="input-img1">
                                                                        <img id="view_img" src="{{ asset($teamMember->image) }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="mail" id="mail" value="{{ $teamMember->mail }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="phone_number" id="phone_number" value="{{ $teamMember->phone_number }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="facebook" id="facebook" value="{{ $teamMember->facebook }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="twitter" id="twitter" value="{{ $teamMember->twitter }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="linkedin" id="linkedin" value="{{ $teamMember->linkedin }}">
                                                    </div>
                                                </div>
