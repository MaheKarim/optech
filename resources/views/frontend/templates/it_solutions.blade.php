            ...
            <nav class="navbar site-navbar">
                ...
                <div class="header-btn header-btn-l1 ms-auto d-none d-xs-inline-flex">
                    <div class="optech-header-icon">
                        ...
                        <a class="optech-default-btn optech-header-btn" href="{{ route('contact-us') }}" data-text="{{ __('Get in Touch') }}">
                            <span
                                class="btn-wraper">{{ __('Get in Touch') }}
                            </span>
                        </a>
                    </div>
...
<div class="section optech-section-padding-bottom">
    <div class="container">
        ...
        <div class="optech-counter-wrap" style="background-image: url({{ asset('frontend/assets/img/v2/counter-bg.png') }})">
