        ...
        <nav class="navbar navbar-expand-xl justify-content-between">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <div class="d-flex flex-column flex-xl-row">
                    <ul>
                      <li>
                        <a href="{{ route('0', ['theme' => 'one']) }}" class="dropdown-item"
            ...
            <div class="d-flex align-items-center gap-4 mt-4">
              <div class="d-flex d-lg-none">
                @if (env('APP_MODE') == 'DEMO')
                    @guest('web')
                        <a href="{{ route('buyer.login') }}" class="header-btn" target="_blank">
                    @else
                        @if(Auth::guard('web')->user()->is_seller == 1)
                            <a href="{{ route('seller.dashboard') }}" class="header-btn" target="_blank">
                        @else
                            <a href="{{ route('buyer.dashboard') }}" class="header-btn" target="_blank">
                        @endif
                    @endguest
          ...
          <div class="navbar-right d-flex align-items-center gap-4">
            ...
            <div class="align-items-center d-none d-lg-flex">
                ...
                @guest('web')
                    @if (env('APP_MODE') == 'DEMO')
                        <a href="{{ route('buyer.login') }}" class="w-btn-secondary-lg" target="_blank">
                    @else
